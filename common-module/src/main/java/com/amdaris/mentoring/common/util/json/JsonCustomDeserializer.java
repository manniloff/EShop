package com.amdaris.mentoring.common.util.json;
...
@NoArgsConstructor
public class JsonCustomDeserializer<T> implements Deserializer<T> {
    ...
    public T deserialize(String topic, byte[] data) {
        ...
        try {
            return objectMapper.readValue(new String(data, "UTF-8"), className);
        } catch (Exception e) {
